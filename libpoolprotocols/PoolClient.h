...
public:
    ...
    virtual void submitSolution(const Solution& solution, unsigned miner_index) = 0;
    virtual bool isConnected() = 0;
    virtual bool isPendingState() = 0;
    virtual string ActiveEndPoint() = 0;

    using SolutionAccepted = std::function<void(bool const&, unsigned miner_index)>;
    using SolutionRejected = std::function<void(bool const&, unsigned miner_index)>;
